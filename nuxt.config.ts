export default defineNuxtConfig({
    ...
    auth: {
        ...
        origin: process.env.VERCEL ? (process.env.VERCEL_ENV == 'production' ? `https://${process.env.VERCEL_GIT_REPO_SLUG}-orpin.vercel.app` : `https://${process.env.VERCEL_URL}`) : 'http://localhost:3000',
